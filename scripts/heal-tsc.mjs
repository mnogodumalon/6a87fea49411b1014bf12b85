...
function parseErrors(output) {
  ...
  return { errors, nullErrors, cmpErrors, total };
}
...
function healFile(filePath, errors, nullErrors, cmpErrors, shapes) {
...
const files = new Set(
  [...parsed.errors, ...parsed.nullErrors, ...parsed.cmpErrors].map((e) => e.file),
);
const fixed = [];
