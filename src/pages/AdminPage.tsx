...
const WERKZEUGE_FIELDS = [
  ...
  { key: 'kategorie', label: 'Kategorie', type: 'lookup/select', options: [{ key: 'elektrowerkzeug', label: 'Elektrowerkzeug' }, { key: 'messgeraet', label: 'Messgerät' }, { key: 'pruefgeraet', label: 'Prüfgerät' }, { key: 'handwerkzeug', label: 'Handwerkzeug' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  ...
  { key: 'werkzeug_status', label: 'Status', type: 'lookup/select', options: [{ key: 'verfuegbar', label: 'Verfügbar' }, { key: 'ausgeliehen', label: 'Ausgeliehen' }, { key: 'in_wartung', label: 'In Wartung' }, { key: 'in_reparatur', label: 'In Reparatur' }, { key: 'ausser_betrieb', label: 'Außer Betrieb' }] },
...
const AUSLEIHE_FIELDS = [
  ...
  { key: 'ausleihdatum', label: 'Ausleihzeitpunkt', type: 'date/datetimeminute' },
  ...
  { key: 'zustand_ausleihe', label: 'Zustand bei Ausleihe', type: 'lookup/select', options: [{ key: 'einwandfrei', label: 'Einwandfrei' }, { key: 'leichte_spuren', label: 'Leichte Gebrauchsspuren' }, { key: 'starke_spuren', label: 'Starke Gebrauchsspuren' }, { key: 'beschaedigt', label: 'Beschädigt' }] },
  { key: 'zustand_rueckgabe', label: 'Zustand bei Rückgabe', type: 'lookup/select', options: [{ key: 'einwandfrei_r', label: 'Einwandfrei' }, { key: 'leichte_spuren_r', label: 'Leichte Gebrauchsspuren' }, { key: 'starke_spuren_r', label: 'Starke Gebrauchsspuren' }, { key: 'beschaedigt_r', label: 'Beschädigt' }] },
  { key: 'bemerkungen_ausleihe', label: 'Bemerkungen', type: 'string/textarea' },
];
const WARTUNGREPARATUR_FIELDS = [
  { key: 'werkzeug_wr', label: 'Werkzeug', type: 'applookup/select', targetEntity: 'werkzeuge', targetAppId: 'WERKZEUGE', displayField: 'werkzeugname' },
  { key: 'vorgangstyp', label: 'Vorgangstyp', type: 'lookup/radio', options: [{ key: 'reparatur', label: 'Reparatur' }, { key: 'wartung', label: 'Wartung' }] },
  { key: 'meldedatum', label: 'Datum der Meldung', type: 'date/date' },
  { key: 'geplantes_datum', label: 'Geplantes Durchführungsdatum', type: 'date/date' },
  { key: 'abschlussdatum', label: 'Abschlussdatum', type: 'date/date' },
  { key: 'beschreibung', label: 'Beschreibung des Problems / der Maßnahme', type: 'string/textarea' },
  { key: 'durchfuehrende_stelle', label: 'Durchführende Stelle', type: 'lookup/radio', options: [{ key: 'intern', label: 'Intern' }, { key: 'extern', label: 'Extern' }] },
  { key: 'kosten', label: 'Kosten (€)', type: 'number' },
  { key: 'vorgang_status', label: 'Status', type: 'lookup/select', options: [{ key: 'offen', label: 'Offen' }, { key: 'in_bearbeitung', label: 'In Bearbeitung' }, { key: 'abgeschlossen', label: 'Abgeschlossen' }] },
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'wartung_reparatur' && fieldKey === 'werkzeug_wr') {
      const match = (lists.werkzeugeList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.werkzeugname ?? '—';
    }
    return String(url);
